...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
 ...
 <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="picform">
                            <!--Blog Name Input -->
                            <p>
                                <label for="bname"> Blog Title </label>
                                <input type="text" placeholder="Blog Title" name="bname" id="bname" value="<?php if(isset($_POST['bname'])); echo $_POST['bname']?>"/>
                            </p>
                            
                            <!--Blog Data Input -->
                             <p>
                                <label for="bdata"> Blog Title </label>
                                <input type="textbox" name="bdata" id="bdata" value="<?php if(isset($_POST['bdata'])); echo $_POST['bdata']?>"/>
                            </p>
