            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    while ($row = pg_fetch_assoc($rtn)) {
                        ...
                        print "<a class='btn btn-default' href='approveUser.php?uname=" .$row['uname']. "' >Approve &raquo;</a>";

                        print "<a class='btn btn-default' href='deleteUser.php?uname=" .$row['uname']. "' >Delete &raquo;</a>";
